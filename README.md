...
Xitzin brings a modern Python developer experience to the [Gemini protocol](https://geminiprotocol.net/). Build Gemini capsules with familiar patterns: decorators for routing, type-annotated path parameters, and Pydantic-powered validation.
